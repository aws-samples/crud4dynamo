...
class UpdateExpressionTest {
    ...
    class RemoveTest extends UpdateExpressionTestBase {
        ...
        @Test
        void case1() {
            parse("REMOVE a", "(start (updateExpression (removeExpression REMOVE (removeAction (path a)))) <EOF>)");
        }
    ...
    class AddTest extends UpdateExpressionTestBase {
        ...
        @Test
        void case2() {
            parse("ADD #a :value", "(start (updateExpression (addExpression ADD (addAction (path #a) :value))) <EOF>)");
        }
    ...
    class DeleteTest extends UpdateExpressionTestBase {
        ...
        @Test
        void case1() {
            parse("DELETE a :value", "(start (updateExpression (deleteExpression DELETE (deleteAction (path a) :value))) <EOF>)");
        }
