 ...
 *
 * <p>Copied from: https://github.com/redskap/aws-dynamodb-java-example-local-testing
 */
class AwsDynamoDbLocalTestUtils {
    ...
    initSqLite(
        () -> {
          final List<String> classPath =
              getClassPathList(System.getProperty("java.class.path"), File.pathSeparator);
   ...
   */
  static void initSqLite(final Supplier<String> libPathSupplier) {
  ...
  /**
   * Calculates the possible Library Names for finding the proper sqlite4j native library and
   * returns the directory with the most specific matching library.
   *
   * @param osName The value of <code>"os.name"</code> system property (<code>
   *     System.getProperty("os.name")</code>).
   * @param runtimeName The value of <code>"java.runtime.name"</code> system property (<code>
   *     System.getProperty("java.runtime.name")
   *                    </code>).
   * @param osArch The value of <code>"os.arch"</code> system property (<code>
   *     System.getProperty("os.arch")</code>).
   * @param osArch The classpath split into strings by path separator. Value of <code>
   *     "java.class.path"</code> system property (<code>
   *                    System.getProperty("os.arch")</code>) split by <code>File.pathSeparator
   *     </code>.
   * @return
   */
  static String getLibPath(
    ...
    throw new IllegalStateException(
        "SQLite library \"" + libNames + "\" is missing from classpath");
  }

  /**
   * Calculates the possible Library Names for finding the proper sqlite4java native library.
   *
   * <p>Based on the internal calculation of the sqlite4java wrapper <a href="https://bitbucket
   ...
   */
  static List<String> getLibNames(final String os, final String arch) {
   ...
   */
  static String getOs(final String osName, final String runtimeName) {
   ...
   *
   * @param classPath Value of <code>"java.class.path"</code> system property (<code>
   *     System.getProperty("os.arch")</code>).
   * @param pathSeparator Value of path separator (<code>File.pathSeparator</code>).
   * @return The list of each classpath elements.
   */
  static List<String> getClassPathList(final String classPath, final String pathSeparator) {
