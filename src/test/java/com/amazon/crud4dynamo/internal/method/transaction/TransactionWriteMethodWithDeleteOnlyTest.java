...
public class TransactionWriteMethodWithDeleteOnlyTest {
    ...
    private interface TestDao {
        @Delete(tableClass = Table1.class, keyExpression = "HashKey = :hashKey", conditionExpression = "#attributeName > :value")
        void delete1(
                @Param(":hashKey") final String key, @Param("#attributeName") final String attribute, @Param(":value") final int value);

        @Delete(tableClass = Table1.class, keyExpression = "HashKey = :hashKey", conditionExpression = "#attributeName > :value")
        @Delete(tableClass = Table2.class, keyExpression = "HashKey = :hashKey", conditionExpression = "#attributeName > :value")
        void delete2(
                @Param(":hashKey") final String key, @Param("#attributeName") final String attribute, @Param(":value") final int value);
    }
    ...
    class SingleTableDeleteTest extends DynamoDbTestBase {
        ...
        public void setUp() throws Exception {
            ...
            final Method method = TestDao.class.getMethod("delete1", String.class, String.class, int.class);
    ...
    class MultipleTablesDeleteTest extends DynamoDbTestBase {
        ...
        public void setUp() throws Exception {
            ...
            final Method method = TestDao.class.getMethod("delete2", String.class, String.class, int.class);
            final Signature signature = Signature.resolve(method, TestDao.class);
            transaction = new TransactionWriteMethod(getDbClient(), getDbMapper(), signature);
        }
