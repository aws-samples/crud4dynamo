...
public class TransactionTest extends DynamoDbTestBase {
    ...
    class WriteTest {
        ...
        void setUp() throws Exception {
            final Method method =
                    Transaction.class.getMethod("write", String.class, String.class, String.class, String.class, Orders.class);
        ...
        void writeSucceeded() throws Throwable {
            ...
            transaction.invoke(customerId, productId, newProductStatus, expectedOldProductStatus, newOrder);
