...
class PutMethodTest extends SingleTableDynamoDbTestBase<PutMethodTest.Model> {
    ...
    private PutMethod newMethod(final String defaultPutMethod2) throws NoSuchMethodException {
        final Signature defaultPutMethod = Signature.resolve(Dao.class.getMethod(defaultPutMethod2, Model.class), Dao.class);
        return new PutMethod(defaultPutMethod, getModelClass(), getDynamoDbMapper(), getDynamoDbClient(), DynamoDBMapperConfig.DEFAULT);
    }
