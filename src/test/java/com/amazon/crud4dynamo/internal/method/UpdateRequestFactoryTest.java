...
class UpdateRequestFactoryTest extends SingleTableDynamoDbTestBase<Model> {
  ...
  void keyExpression_Shares_Nothing_With_OtherExpressions() throws Throwable {
    final Method updateRangeKeyMethod =
        Dao.class.getMethod("update1", String.class, String.class, int.class);
    final Signature signature = Signature.resolve(updateRangeKeyMethod, Dao.class);
    final UpdateRequestFactory updateRequestFactory =
        new UpdateRequestFactory(signature, getModelClass(), getDynamoDbMapper());

    final UpdateItemRequest updateItemRequest =
        updateRequestFactory.create("hashKeyValue", "RangeKey", 1984);

    assertThat(updateItemRequest.getTableName()).isEqualTo("Table");
    assertThat(updateItemRequest.getKey())
        .containsEntry("HashKey", new AttributeValue("hashKeyValue"));
    assertThat(updateItemRequest.getKey())
        .containsEntry("RangeKey", new AttributeValue().withN("1984"));
  ...
  void keyExpression_Shares_A_Argument_With_OtherExpressions() throws Throwable {
    final Method updateRangeKeyMethod =
        Dao.class.getMethod("update2", String.class, String.class, int.class);
    final Signature signature = Signature.resolve(updateRangeKeyMethod, Dao.class);
    final UpdateRequestFactory updateRequestFactory =
        new UpdateRequestFactory(signature, getModelClass(), getDynamoDbMapper());
    ...
    assertThat(updateItemRequest.getExpressionAttributeValues())
        .containsValues(new AttributeValue().withN("1984"));
    assertThat(updateItemRequest.getConditionExpression()).isNull();
  ...
  void withConditionExpression() throws Throwable {
    final Method updateRangeKeyMethod =
        Dao.class.getMethod(
            "update3", String.class, String.class, int.class, String.class, String.class);
    final Signature signature = Signature.resolve(updateRangeKeyMethod, Dao.class);
    final UpdateRequestFactory updateRequestFactory =
        new UpdateRequestFactory(signature, getModelClass(), getDynamoDbMapper());

    final UpdateItemRequest updateItemRequest =
        updateRequestFactory.create("hashKeyValue", "RangeKey", 1984, "Str1", "str");
    ...
    assertThat(updateItemRequest.getExpressionAttributeValues())
        .containsEntry(":rangeKey", new AttributeValue().withN("1984"));
    assertThat(updateItemRequest.getExpressionAttributeValues())
        .containsEntry(":str", new AttributeValue("str"));
    assertThat(updateItemRequest.getReturnValues()).isEqualTo(ReturnValue.NONE.toString());
  }
  ...
  void updateExpression_Only_Contains_ExpressionAttributeNames() throws Throwable {
    final Method method =
        Dao.class.getMethod("update4", String.class, String.class, int.class, String.class);
    final Signature signature = Signature.resolve(method, Dao.class);
    final UpdateRequestFactory updateRequestFactory =
        new UpdateRequestFactory(signature, getModelClass(), getDynamoDbMapper());

    final UpdateItemRequest updateItemRequest =
        updateRequestFactory.create("hashKeyValue", "RangeKey", 1984, "Str1");
