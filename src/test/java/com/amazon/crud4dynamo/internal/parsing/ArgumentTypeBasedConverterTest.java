...
class ArgumentTypeBasedConverterTest {
    ...
    void nested_map1() {
        ...
        assertThat(attributeValue)
                .isEqualTo(new AttributeValue().addMEntry("A", new AttributeValue().addMEntry("B", new AttributeValue().withN("1"))));
    }
    ...
    void list1() {
        ...
        assertThat(convert(alist))
                .isEqualTo(
                        new AttributeValue().withL(new AttributeValue("A"), new AttributeValue().addMEntry("A", new AttributeValue("B"))));
    }
    ...
    @Test
    void binary_set() {
        final Set<Object> aset = ImmutableSet.of(new byte[] {0x1}, new byte[] {0x2}, ByteBuffer.wrap(new byte[] {0x3}));
