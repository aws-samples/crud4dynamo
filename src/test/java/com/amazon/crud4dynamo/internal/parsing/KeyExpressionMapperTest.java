...
class KeyExpressionMapperTest extends SingleTableDynamoDbTestBase<Model> {
    ...
    void hashKeyContext_case1() {
        final KeyExpressionMapper mapper = new KeyExpressionMapper("HashKey = :value1", getDynamoDbMapperTableModel());
        ...
        assertThat(hashKeyContext.getValueMapper().get(":value1").convert("hashKey")).isEqualTo(new AttributeValue("hashKey"));
    }
    ...
    void hashKeyContext_case2() {
        ...
        final AttributeValueConverter converter =
                hashKeyContext.getNameMapper().toValueMapper(ImmutableMap.of("#hashKey", "HashKey")).get(":value1");
    ...
    void rangeKeyContext_case1() {
        final KeyExpressionMapper mapper = new KeyExpressionMapper("HashKey = :value1, RangeKey = :value2", getDynamoDbMapperTableModel());
        ...
        assertThat(context.get().getValueMapper().get(":value2").convert(100)).isEqualTo(new AttributeValue().withN("100"));
    }
    ...
    void rangeKeyContext_case2() {
        ...
        final AttributeValueConverter converter =
                context.get().getNameMapper().toValueMapper(ImmutableMap.of("#rangeKey", "RangeKey")).get(":value2");
