...
class ProjectionExpressionParserTest {
  ...
  void expressionWithoutExpressionAttributeNames() {
    final ProjectionExpressionParser parser =
        new ProjectionExpressionParser("attributeName1,attributeName2");
  ...
  void expressionWithExpressionAttributeNames() {
    final ProjectionExpressionParser parser =
        new ProjectionExpressionParser("attributeName1,#expressionAttributeName1");
