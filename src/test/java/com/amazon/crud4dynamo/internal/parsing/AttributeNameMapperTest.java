...
class AttributeNameMapperTest {
    ...
    void merge() {
        final Function function = mock(Function.class);
        final String key = "KEY";
        final AttributeNameMapper mergedMapper = mapper.put(key, function).merge(new AttributeNameMapper().put(key, function));
    ...
    void toValueMapper() {
        ...
        final AttributeValueMapper valueMapper =
                mapper.put(expressionAttributeName, function).toValueMapper(ImmutableMap.of(expressionAttributeName, attributeName));
