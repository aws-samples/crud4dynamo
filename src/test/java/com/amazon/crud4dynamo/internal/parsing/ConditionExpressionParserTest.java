...
public class ConditionExpressionParserTest extends SingleTableDynamoDbTestBase<ConditionExpressionParserTest.Model> {
    @Data
    @Builder
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    class LeftCompareExpression {
        ...
        void withAttributeName() {
            ...
            final AttributeValueMapper expectedValueMapper =
                    new AttributeValueMapper(ImmutableMap.of(":val", obj -> getDynamoDbMapperTableModel().rangeKey().convert(obj)));

            final ConditionExpressionParser mapper = new ConditionExpressionParser(filterExpression, getDynamoDbMapperTableModel());
        ...
        void withNestedPath() {
            ...
            final ImmutableMap<String, Object> arguments = ImmutableMap.of(":val", 10);
            final AttributeValueMapper expectedValueMapper =
                    new AttributeValueMapper(ImmutableMap.of(":val", obj -> new AttributeValue().withN("10")));
        ...
        void withExpressionAttributeName() {
            ...
            final AttributeValueMapper valueMapper = nameMapper.toValueMapper(ImmutableMap.of("#nameHolder", "RangeKey"));
            assertThat(applyArguments(arguments, valueMapper)).isEqualTo(applyArguments(arguments, expectedValueMapper));
        }
    }
    ...
    class AttributeTypeFunction {
        ...
        void withAttributeName() {
            ...
            final AttributeValueMapper expectedValueMapper =
                    new AttributeValueMapper(ImmutableMap.of(":type", obj -> new AttributeValue().withS("Number")));
    ...
    class BeginsWithFunction {
        ...
        void withAttributeName() {
            ...
            final AttributeValueMapper expectedValueMapper =
                    new AttributeValueMapper(ImmutableMap.of(":val", obj -> new AttributeValue().withS("Abc")));
