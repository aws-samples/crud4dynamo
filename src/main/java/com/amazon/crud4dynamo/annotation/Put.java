...
public @interface Put {
  /**
   * Specify the expression attribute value for the item to be created. By default it is set to
   * ":item". Besides you have to declare a parameter with Param annotation like <code>
   *  @Param(":an_item") final ItemType itemForPut </code>
   */
