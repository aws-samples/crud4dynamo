...
public class ExpressionFactoryHelper {
  ...
  public static Map<String, String> getExpressionAttributeNames(
      @NonNull final List<Argument> args) {
  ...
  /**
   * Traverse arguments annotated with @Param(":..."), and for each argument contained in
   * valueMapper creates a mapping from ":..." to AttributeValue.
   */
  ...
  public static Optional<PageRequest> findPageRequest(final Object... args) {
    return Stream.of(args)
        .filter(PageRequest.class::isInstance)
  ...
  private static Function<Argument, AttributeValue> getAttribute(
