...
public class UpdateFactory {
  ...
  public UpdateFactory(
      final com.amazon.crud4dynamo.annotation.transaction.Update updateAnnotation,
      final DynamoDBMapperTableModel tableModel) {
    this.updateAnnotation = updateAnnotation;
    this.tableModel = tableModel;
    keyAttributeConstructor =
        new KeyAttributeConstructor(updateAnnotation.keyExpression(), tableModel);
  ...
  public Update create(final List<Argument> arguments) {
    return new Update()
        ...
        .withUpdateExpression(
            ExpressionFactoryHelper.toNullIfBlank(updateAnnotation.updateExpression()))
        .withConditionExpression(
            ExpressionFactoryHelper.toNullIfBlank(updateAnnotation.conditionExpression()))
        ...
        .withReturnValuesOnConditionCheckFailure(
            updateAnnotation.returnValuesOnConditionCheckFailure());
  }
}
